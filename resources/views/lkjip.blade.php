      ...
      <div class="container">
        <div  data-aos="zoom-out" data-aos-duration="1500" class="row">
          <div class="col-12 col-md-6 hero-desc d-flex justify-content-center align-items-center">
            <div class="hero-title">
              ...
              <div class="hero-content">
                <p>
                  LKJIP merupakan dokumen pelaporan wajib yang berfungsi sebagai indikator akuntabilitas dari pelaksanaan
                ...
                <ul>
                  @if ($documents->count() > 0)
                    @foreach ($documents as $document)
                      <li>
                        <a href="{{ asset('storage/documents/lkjip/' . $document->file) }}" target="_blank" rel="noopener">
          ...
          <div class="col text-center d-flex justify-content-center align-items-center">
            @if ($latestDocument)
              <a href="{{ asset('storage/documents/lkjip/' . $latestDocument->file) }}" target="_blank" rel="noopener"
                class="icon-document">
                <img src="{{ asset('assets/illustration/document.svg') }}" alt="LKJIP" class="justify-content-center"
                  style="width: 300px;">
                <p class="text-center">
                  <strong>
