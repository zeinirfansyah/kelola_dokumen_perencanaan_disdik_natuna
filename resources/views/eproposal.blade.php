      ...
      <div class="container">
        <div  data-aos="zoom-out" data-aos-duration="1500" class="row">
                ...
                <ul>
                  @if ($documents->count() > 0)
                    @foreach ($documents as $document)
                      <li>
                        <a href="{{ asset('storage/documents/eproposal/' . $document->file) }}" target="_blank"
                          rel="noopener">
          ...
          <div class="col text-center hero-desc d-flex justify-content-center align-items-center">
            @if ($latestDocument)
              <a href="{{ asset('storage/documents/eproposal/' . $latestDocument->file) }}" target="_blank" rel="noopener"
                class="icon-document">
                <img src="{{ asset('assets/illustration/document.svg') }}" alt="Eproposal Pendidikan"
