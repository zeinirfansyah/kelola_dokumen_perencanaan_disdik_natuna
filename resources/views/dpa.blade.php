      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-md-6 hero-desc hero-desc d-flex justify-content-center align-items-center">
            <div class="hero-title">
              ...
              <div class="hero-content">
                <p>
                  Dokumen yang memuat pendapatan dan belanja setiap OPD yang digunakan sebagai dasar pelaksanaan oleh pengguna anggaran.
                </p>
                <ul>
                  @if ($documents->count() > 0)
                    @foreach ($documents as $document)
                      <li>
                        <a href="{{ asset('storage/documents/dpa/' . $document->file) }}" target="_blank"
                          rel="noopener">
          ...
          <div class="col text-center hero-desc d-flex justify-content-center align-items-center">
            @if ($latestDocument)
              <a href="{{ asset('storage/documents/dpa/' . $latestDocument->file) }}" target="_blank" rel="noopener"
                class="icon-document">
                <img src="{{ asset('assets/illustration/document.svg') }}" alt="Dpa Pendidikan"
