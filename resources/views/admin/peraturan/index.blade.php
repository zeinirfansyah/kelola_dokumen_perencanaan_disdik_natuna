  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Dokumen Peraturan Pendidikan</h1>
          </div>
          <!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item">Home</li>
              <li class="breadcrumb-item active">Dokumen Peraturan Pendidikan</li>
            </ol>
          </div>
          <!-- /.col -->
        </div>
            ...
            <div class="container-fluid">
              <div class="card">
                <div class="card-header">
                  <a href="{{ route('peraturan.create') }}" class="btn btn-default">Add Peraturan</a>

                  <div class="card-tools">
                    <form method="GET" action="{{ route('peraturan.index') }}" class="form-inline">
                      <div class="input-group input-group-sm" style="width: 300px">
                        <select name="tahun" class="form-control">
                          <option value="all" disabled selected>Semua</option>
                    ...
                    <tbody>
                      @foreach ($documents as $document)
                        <tr>
                          ...
                          <td class="col-4">
                            <a href="{{ asset('storage/documents/peraturan/' . $document->file) }}"
                          ...
                          <td class="col-2">
                            <a href="{{ route('peraturan.update', ['id' => $document->id]) }}" class="btn btn-default">Edit</a>
                            <form action="{{ route('peraturan.delete', ['id' => $document->id]) }}" method="POST" class="d-inline">
                              @csrf
                              @method('DELETE')
