  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Update Rencana Kerja Dinas Pendidikan</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item">Home</li>
              <li class="breadcrumb-item">Update Renja Diknas</li>
    ...
    <div class="content">
      <div class="container-fluid">
        ...
        @endif
        <div class="card p-3">
          <form action="{{ route('renja.edit', ['id' => $document->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf @method('PUT')
