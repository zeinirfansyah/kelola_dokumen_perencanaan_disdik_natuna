  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Dokumen LRFK</h1>
          </div>
          <!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item">Home</li>
              <li class="breadcrumb-item active">Dokumen LRFK</li>
            </ol>
          </div>
          <!-- /.col -->
        </div>
            ...
            <div class="container-fluid">
              <div class="card">
                <div class="card-header">
                  <a href="{{ route('lrfk.create') }}" class="btn btn-default">Add</a>

                  <div class="card-tools">
                    <form method="GET" action="{{ route('lrfk.index') }}" class="form-inline">
                    ...
                    <tbody>
                      @foreach ($documents as $document)
                        <tr>
                          ...
                          <td class="col-4">
                            <a href="{{ asset('storage/documents/lrfk/' . $document->file) }}"
                          ...
                          <td class="col-2">
                            <a href="{{ route('lrfk.update', ['id' => $document->id]) }}" class="btn btn-default">Edit</a>
                            <form action="{{ route('lrfk.delete', ['id' => $document->id]) }}" method="POST" class="d-inline">
                              @csrf
                              @method('DELETE')
