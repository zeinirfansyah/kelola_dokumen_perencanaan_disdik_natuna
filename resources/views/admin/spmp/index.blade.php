  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Dokumen SPMP</h1>
          </div>
          <!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item">Home</li>
              <li class="breadcrumb-item active">Dokumen SPMP</li>
            </ol>
          </div>
          <!-- /.col -->
        </div>
            ...
            <div class="container-fluid">
              <div class="card">
                <div class="card-header">
                  <a href="{{ route('spmp.create') }}" class="btn btn-default">Add SPMP</a>

                  <div class="card-tools">
                    <form method="GET" action="{{ route('spmp.index') }}" class="form-inline">
                    ...
                    <tbody>
                      @foreach ($documents as $document)
                        <tr>
                          ...
                          <td class="col-2">
                            <a href="{{ route('spmp.update', ['id' => $document->id]) }}" class="btn btn-default">Edit</a>
                            <form action="{{ route('spmp.delete', ['id' => $document->id]) }}" method="POST" class="d-inline">
                              @csrf
                              @method('DELETE')
